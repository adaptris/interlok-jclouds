...
public abstract class OperationCase {
  ...
  public static BlobStoreConnection createConnection() throws Exception {
    ...
    BlobStoreConnection c = new BlobStoreConnection().withProvider("filesystem").withConfiguration(config);
    return c;
  }

  public static void createBlob(BlobStoreContext ctx, String container, String name, String content) {
